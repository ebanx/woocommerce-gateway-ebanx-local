...
<div class="error">
	<p><strong><?php esc_html_e( 'EBANX Pay Payment Gateway for WooCommerce', 'woocommerce-gateway-ebanx' ); ?></strong> <?php esc_html_e( 'depends on the last version of WooCommerce to work!', 'woocommerce-gateway-ebanx' ); ?></p>
